<nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
    <div class="container flex flex-wrap items-center justify-between mx-auto">
        ...
        {{-- Navigation --}}
        <button data-collapse-toggle="nav_button" type="button"
            class="inline-flex items-center p-2 ml-1 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
            aria-controls="nav_button" aria-expanded="true" id="nav_button">
        ...
        <div class="items-center hidden justify-between w-full md:flex md:w-auto md:order-1" id="nav_dropdown">
            <ul
        ...
        @auth('web')
            <div class="flex items-center md:order-2 relative">
                <button type="button"
                    ...
                    id="profile_view" onclick="profile()">
                    <span class="sr-only">Open user menu</span>
                    <img class="w-8 h-8 rounded-full" src="/docs/images/people/profile-picture-3.jpg" alt="user photo">
                </button>
                <!-- Dropdown menu -->
                <div class="hidden z-50 absolute right-0 top-full overflow-hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600"
                    id="profile_dropdown">
                    <div class="px-4 py-3">
        ...
        <div class="flex items-center md:order-3 ">
            @guest
                <div class="mr-2">
                    <a href="{{ route('login') }}"
                        class="text-sm font-semibold leading-6 text-gray-900 hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Log
                        in <span aria-hidden="false">&rarr;</span></a>
                </div>
            @endguest
        </div>
    </div>
